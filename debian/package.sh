...
fpm -s dir -t deb -C /tmp/iptables-daemon-go --name iptables-daemon-go --version 0.0.1 --iteration 1 --description "iptables management in go" --package /tmp/iptables-daemon-go
